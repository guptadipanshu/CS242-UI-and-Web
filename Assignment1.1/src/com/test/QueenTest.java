...
public class QueenTest {
	...
	private void testTwoKill() {
		...
		board.addPiece("Queen",WHITE,0,0);
		board.addPiece("King",BLACK,6,6);
		board.addPiece("Knight",BLACK,7,6);
		Vector<Integer> moves= new Vector<Integer>();
		moves=board.selectPieceMovement("Queen",0,0);
		board.makeMovement("Queen",0,0,54);
		moves=board.selectPieceMovement("Queen",6,6);
		board.makeMovement("Queen",6,6,62);
		moves=board.selectPieceMovement("Queen",7,6);
	...
	private void testTopRight() {
		Board board=new Board();
		board.addEmptySpaces();
		board.addPiece("Queen",WHITE,0,7);
		Vector<Integer> moves= new Vector<Integer>();
		moves=board.selectPieceMovement("Queen",0,7);
		Collections.sort(moves);
		Vector<Integer> solution= new Vector<Integer>();
	...
	private void testBottomRight() {
		Board board=new Board();
		board.addEmptySpaces();
		board.addPiece("Queen",WHITE,7,7);
		Vector<Integer> moves= new Vector<Integer>();
		moves=board.selectPieceMovement("Queen",7,7);
		Collections.sort(moves);
		Vector<Integer> solution= new Vector<Integer>();
	...
	private void testBottomLeft() {
		Board board=new Board();
		board.addEmptySpaces();
		board.addPiece("Queen",WHITE,7,0);
		Vector<Integer> moves= new Vector<Integer>();
		moves=board.selectPieceMovement("Queen",7,0);
		Collections.sort(moves);
		Vector<Integer> solution= new Vector<Integer>();
